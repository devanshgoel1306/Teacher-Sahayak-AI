...
"[project]/src/ai/flows/teach-anything.ts [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$teach$2d$anything$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/ai/flows/teach-anything.ts [app-client] (ecmascript)");
...
function DashboardClient() {
        ...
        "DashboardClient.useEffect": ()=>{
            ...
            if (SpeechRecognition) {
                ...
                recognitionRef.current.onresult = ({
                    "DashboardClient.useEffect": (event)=>{
    ...
    const processPrompt = async (promptText, isVoice = false)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$teach$2d$anything$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["teachAnything"])({
                history: newMessages
            });
            setMessages((prev)=>[
                    ...prev,
...
_s(DashboardClient, "KH6ZX5JxIO8d9FBTSbkfjIQ03as=", false, function() {
    return [
...
//# sourceMappingURL=_cca7c0ab._.js.map